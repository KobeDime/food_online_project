...
<head>
    ...
    <link rel="icon" href="#">
    <title>Kobe Pinoy Plates - Dishes</title>
...
<body>
    ...
    <div class="page-wrapper">
        <div class="top-links" style="margin-top: 30px;">
            <div class="container">
                <ul class="row links">
                                    ...
                                    <div class="food-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                                ...
                                                <input class="b-r-0" type="text" name="quantity" style="margin-left:30px; margin-bottom: 20px;" value="1" size="2" />
