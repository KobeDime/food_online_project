...
<body class="home">
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="icons/logo.png" alt=""> </a>
    ...
    <section class="hero bg-image" data-image-src="images/bg-main.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Kobe Pinoy Plates </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;"></span>Choose Your Flavor</h4>
                    </div>
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;"></span>Satisfy Your Craving</h4>
                    </div>
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;"></span>Enjoy Delivery or Pick-Up</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>This Month's Must-Try Delights</h2>
                <p class="lead">Discover the simplest way to savor your favorite flavors with our top standout dishes.</p>
            </div>
            <div class="row">
                <?php
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Discover Your Flavor Haven</h3>
                                <p>Explore an array of mouthwatering menus from top-notch restaurants delivered straight to your screen.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Satisfy Your Culinary Craving</h3>
                            <p>Indulge in a diverse selection of delectable dishes from a curated list of delivery spots online.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Doorstep Delivery or Dine-Out Bliss</h3>
                            <p>Have your favorites delivered right to your door or pick them up for a delightful dine-out experience. Enjoy every bite! </p>
                        </div>
                    </div>
                </div>
            </div>
