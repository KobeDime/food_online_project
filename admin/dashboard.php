    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><img src="images/icon.png"
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                <div class="col-lg-12">
                    <div class="card card-outline-primary" style="background-color: #e7eaf6;">
                        ...
                        <div class="row">
                                    ...
                                    <div class="media">
                                        <div class="media-left meida media-middle">
                                            <span><i aria-hidden="true"
                                                    style="font-size: 40px; color: #67757C;">₱</i></span>
                                        </div>
                                        <div class="media-body media-text-right">
                                            <h2><?php
                            ...
                            <div class="col-md-4">
                                <div class="card p-30">
                                    <div class="media">
                                        <div class="media-left meida media-middle">
                                            <span><i class="fa fa-user-shield" aria-hidden="true"
                                                    style="font-size: 40px; color: #67757C;"></i></span>
                                        </div>
                                        <div class="media-body media-text-right">
                                            <h2>
                                                <?php
                                                    // Fetching admin's name from the database
                                                    $result = mysqli_query($db, 'SELECT username FROM admin WHERE adm_id = 1');
                                                    $row = mysqli_fetch_assoc($result);
                                                    $admin_name = $row['username'];
                                                    echo $admin_name;
                                                    ?>
                                            </h2>
                                            <p class="m-b-0">Admin Name</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
