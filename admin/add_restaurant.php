            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/icon.png" alt="user" class="profile-pic" /></a>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_days" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                    ...
                                                    <option value="Tues-Sun">Tues-Sun</option>
                                                    <option value="Wed-Sat">Wed-Mon</option>
                                                    ...
                                                    <option value="Mon-Sun 24hr">Mon-Sun 24hr</option>
